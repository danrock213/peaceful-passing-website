...
// Dynamically import client-only VendorInteractions for reviews + messages
const VendorInteractions = dynamic(() => import('@/components/vendor/VendorInteractions'), {
  ssr: false,
...
export default async function VendorDetailPage({ params }: Props) {
  ...
  return (
    <main className="max-w-4xl mx-auto p-6">
      ...
      {/* Interactive reviews and messaging */}
